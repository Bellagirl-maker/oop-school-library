...
**OOP School Library** is a Ruby app that allows you to:

Add new students or teachers.
Add new books.
Save records of who borrowed a given book and when it was borrowed built in a beautiful and well-organized way
...
```sh
  git clone `https://github.com/Bellagirl-maker/oop-school-library.git`
